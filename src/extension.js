...
function activate(context) {
  const status = context.globalState.get('extension.fix_cursor_color', '')
  if (status === '') {
  ...
  context.subscriptions.push(vscode.commands.registerCommand('extension.fix_cursor_color.enable', function() { enable(context) }))
  context.subscriptions.push(vscode.commands.registerCommand('extension.fix_cursor_color.disable', function() { disable(context) }))
}
